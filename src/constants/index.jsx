export const features = [
  {
    id: "0",
    icon: "/feature.png",
    caption: "Smart task automation",
    title: "Let AI do the heavy lifting",
    text: "Taskflow AI automates your repetitive workflows with precision. From recurring tasks to smart reminders, it frees up your time so you can focus on what really matters.",
    button: {
      icon: "/magictouch.svg",
  ...
  },
  {
    ...
    text: "Whether you're working solo or in a team, Taskflow AI keeps everyone aligned. Share updates, assign tasks, and track progress effortlessly in one unified platform.",
    button: {
      icon: "/docs.svg",
...
export const details = [
  ...
  },
  {
    id: "2",
    icon: "/detail-3.png",
    title: "Lightning-fast cloud sync",
  },
  {
    id: "3",
    icon: "/detail-4.png",
    title: "24 / 7 productivity support",
  },
]
...
export const faq = [
  {
    id: "0",
    question: "How easy is it to set up Taskflow AI?",
    answer:
      "Getting started is simple. Just sign up, choose a workspace name, and start adding tasks. Most users are up and running in under 5 minutes.",
  },
  {
    id: "1",
    question: "Can I integrate Taskflow with other platforms?",
    answer:
      "Yes! Taskflow AI connects with tools like Google Calendar, Slack, Notion, and more to streamline your workflow.",
  },
  {
    id: "2",
    question: "How often do you release new features?",
    answer:
      "We roll out improvements and new features every few weeks, based on community feedback and evolving productivity needs.",
  },
  {
    id: "3",
  ...
  {
    id: "4",
    question: "Do you offer plans for companies or large teams?",
    answer:
      "Absolutely. We offer scalable corporate plans with advanced permissions, reporting, and onboarding support. Contact sales for details.",
  },
  {
    id: "5",
    question: "What happens if I run out of storage?",
    answer:
      "You'll be notified as you approach your storage limit. You can upgrade your plan or archive older projects to free up space.",
  },
  {
    id: "6",
    question: "Can I upgrade or downgrade my plan anytime?",
    answer:
      "Yes. You can change your plan whenever you want, and any unused time on your current plan will be credited automatically.",
  },
  {
    id: "7",
    question: "How do I invite team members?",
    answer:
      "Go to your workspace settings and click 'Invite Members'. You can invite by email and assign roles instantly.",
  },
  {
    id: "8",
    question: "Do you offer onboarding or training sessions?",
    answer:
      "Yes. We provide live onboarding sessions, tutorials, and dedicated support for both individuals and teams.",
  },
  {
    id: "9",
    question: "I’m locked out of my account, what should I do?",
    answer:
      "Use the 'Forgot Password' option on the login screen or contact our support team for immediate assistance.",
  },
]
...
export const plans = [
  {
    ...
    priceMonthly: 19,
    priceYearly: 12,
    caption: "Perfect for solo professionals",
    features: [
      "100MB task storage",
  ...
  },
  {
    ...
    priceMonthly: 79,
    priceYearly: 59,
    caption: "Power tools for power users",
    features: [
...
export const testimonials = [
  {
    ...
    comment:
      "Taskflow’s support team is incredible. Anytime we hit a roadblock, they jump in fast with real solutions.",
  },
  {
    id: "1",
    name: "Mark Erixon",
    ...
    comment:
      "I wasn’t sure we needed another task tool—until we tried Taskflow. Now it’s at the heart of our daily operations.",
  },
  {
    id: "2",
    name: "Melanie Hurst",
    ...
    comment:
      "Onboarding was effortless. Taskflow makes organizing projects feel less like a chore and more like progress.",
  },
  {
    id: "3",
    name: "Alicia Barker",
    ...
    comment:
      "The insights dashboard feels like a secret weapon. We’ve been able to improve delivery times just by using it consistently.",
  },
  {
    id: "4",
    name: "Becky Snider",
    ...
    comment:
      "We switched to Taskflow last month and immediately noticed how much smoother our team collaboration became.",
  },
  {
    id: "5",
    name: "Jim Bradley",
    ...
    comment:
      "The productivity boost is real. Taskflow has completely reshaped how we plan and execute our projects.",
  },
]
